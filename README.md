...
int main(void)
{
  ...
  while (1)
  {
	  printf(" Paveen Kumaran SV\n");
			  printf("212224220071/n");
			HAL_Delay(500);
    /* USER CODE END WHILE */
...
## Output screen shots of Serial port utility   :
 ...
 <img width="1919" height="1079" alt="Screenshot 2026-02-09 143525" src="https://github.com/user-attachments/assets/c92f6869-0769-4604-84f1-d4558240dbb7" />
